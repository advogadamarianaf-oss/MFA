...
layout: default
nav_order: 7
description: "Referencia das 4 skills customizadas do Claude Code usadas no projeto"
---
...
| Coluna | Conteudo |
|:-------|:---------|
| B | NOME (ordem de processamento) |
| C | TELEFONE (confirmacao) |
| M | RESUMO APOS 24H |
| N | RESUMO APOS 7 DIAS |
| O | RESUMO APOS 15 DIAS |
| P | RESUMO APOS 30 DIAS |
