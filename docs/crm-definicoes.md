...
nav_order: 5
nav_title: CRM
description: "Definicao dos 12 estagios do funil CRM e regras de classificacao"
---
...
| 2 | **LEAD NAO DEU A 1a RESPOSTA** | Foram enviados follow-ups e o lead nao respondeu. | Mensagens do escritorio sem retorno. |
| 3 | **LEAD RECEBEU FLUXOGRAMA** | Lead recebeu o fluxo automatizado de mensagens. | Sequencia automatica enviada. |
| 4 | **ATENDIMENTO HUMANO** | Lead avancou do automatico para atendente humano. | Atendente real respondendo. |
| 5 | **Aguardando Reuniao** | Reuniao combinada mas ainda nao agendada. | Interesse manifestado; sem data. |
| 6 | **REUNIAO AGENDADA CLIENTES** | Reuniao marcada com data/hora. | Data e horario confirmados. |
| 7 | **Reuniao Agendada - DEFESA** | Reuniao marcada, caso de defesa profissional. | Demanda de defesa medica/odonto. |
| 8 | **NAO Compareceu a REUNIAO** | Reuniao marcada mas o lead faltou. | No-show; reagendamento pendente. |
...
| 12 | **Lead Desqualificado** | Lead fora do perfil ou sem interesse. | Sem fit, desistencia. |
